          ...
          {trimis ? (
            ...
            <div style={{ background: 'linear-gradient(145deg, rgba(255,255,255,0.05), rgba(255,255,255,0.02))', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '24px', padding: '40px', backdropFilter: 'blur(10px)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '20px 0' }}>
                ...
                <span style={{ color: '#444466', fontSize: '13px' }}>sau</span>
                <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.08)' }} />
              </div>
              ...
              <a
                ...
                className="btn-wa"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', width: '100%', background: 'rgba(37,211,102,0.1)', border: '1px solid rgba(37,211,102,0.3)', color: '#25d366', padding: '16px', borderRadius: '14px', fontSize: '16px', fontWeight: 700, textDecoration: 'none', boxSizing: 'border-box' as const }}>
                Scrie-mi direct pe WhatsApp
              </a>

              <p style={{ color: '#444466', fontSize: '12px', textAlign: 'center', margin: '14px 0 0', lineHeight: 1.6 }}>
                Datele tale sunt in siguranta. Niciun spam, promis.
              </p>
            </div>
          )}
        </div>
